    ...
    <div class="main">
      ...
      <div class="loginbox">
        ...
        <div class="loginbox-in">
          <div class="userbox">
            <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" status-icon>
              <el-form-item label="智慧睡眠" style="font-size: larger" class="formContainer1">
                <!--字体放大居中-->
              </el-form-item>
              <el-form-item label="智慧睡眠睡眠分期和评估" class="formContainer2"></el-form-item>
              ...
              <el-form-item>
                <el-button type="primary" @click="submitForm(ruleFormRef)" class="login_btn" style="margin-right: 40px; margin-left: 20px">
                  登录
                </el-button>
                <el-button type="primary" @click="submitForm1(ruleFormRef)" class="login_btn"> 注册 </el-button>
              </el-form-item>
            </el-form>
          </div>
        </div>
        ...
        <div class="background">
          <div class="title">欢迎使用智慧睡眠系统</div>
        </div>
      </div>
    </div>
  </div>
...
const handleLogin1 = () => {
  changeUser({
    ...
    role: {
      roleName: '管理员',
      roleType: 1,
      rights: ['/index', '/data-upload', '/data-analysis', '/data-show', '/manage', '/manage/rightlist', '/manage/rolelist', '/more']
    }
  })
  router.push('/index')
}
...
const handleLogin2 = () => {
  changeUser({
    ...
    role: {
      roleName: '用户',
      roleType: 2,
      rights: ['/index', '/data-upload', '/monitor', '/data-analysis', '/data-show', '/more', '/data', '/data-report']
    }
  })
  router.push('/index')
}
