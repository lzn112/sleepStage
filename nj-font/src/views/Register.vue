          ...
          <div class="userbox">
            <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" status-icon>
              ...
              <el-form-item class="pwdbox" label="确认密码" prop="password1">
                <input v-model="ruleForm.password1" type="password" style="width: 130px" />
              </el-form-item>
              <el-form-item>
                <el-button type="primary" @click="submitForm(ruleFormRef)" class="login_btn" style="margin-left: 50px; width: 150px">
                  注册
                </el-button>
              </el-form-item>
            </el-form>
